...
import Trolley from "../AdvanceSetting/Trolleys1.jpg";

const Trolleys = ({ categoryId }) => {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        setLoading(true);
        const response = await axios.get(`/api/category/69e5461ef5f270d5d903c0eb/products`);
        setProducts(response.data);
        setLoading(false);
      } catch (error) {
        setError("Our trolley collection is currently being updated.");
        setLoading(false);
      }
    };
    fetchProducts();
                    ...
                    <div className="space-y-3 px-1">
                      ...
                      <div className="flex justify-between items-center">
                        <span className="text-xs uppercase tracking-[0.15em] font-medium truncate max-w-[60%]"
                          style={{ color: colors.textSecondary }}>
                          {product.brand || 'Professional Salon'}
                        </span>
                ...
                <div className="inline-flex items-center gap-3 px-6 py-3 border rounded-full"
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-xs uppercase tracking-[0.2em] font-medium"
                      style={{ color: colors.textSecondary }}>
                      Showing {products.length} Professional Salon Trolleys
                    </span>
                  </div>
                </div>
              </motion.div>
