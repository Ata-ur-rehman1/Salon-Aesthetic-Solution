        ...
        >
          ...
          <motion.form onSubmit={submitHandler} className={`space-y-4 ${getGap('gap-4', 'gap-6', 'gap-6')}`} variants={containerVariants}>
            ...
            <motion.button
              type="submit"
              disabled={isLoading}
              className={`w-full ${getPadding('px-6 py-3', 'px-8 py-4', 'px-8 py-4')} bg-pink-500 text-white ${getTextSize('text-xs', 'text-sm', 'text-sm')} uppercase tracking-[0.2em] font-medium rounded-lg disabled:opacity-50`}
